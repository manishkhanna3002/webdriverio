exports.config = {
   ...
   // Suites: {
   //     debitcard:["relative path of first spec file", "relative path of first spec file"],
   //     Creditcard:["relative path of first spec file", "relative path of first spec file"],
   //     },
